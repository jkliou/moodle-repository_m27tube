...
set_include_path(get_include_path() . PATH_SEPARATOR . $CFG->dirroot . '/repository/m27tube/google');
require_once($CFG->dirroot . '/repository/m27tube/google/Google/Client.php');
